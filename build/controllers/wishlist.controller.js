...
var addWishList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return wishListService.addWishList(req.params._id, req.body);
          case 3:
            data = _context.sent;
  ...
  return function addWishList(_x, _x2, _x3) {
...
var getAllWishlist = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return wishListService.getAllWishlist(req.body);
          case 3:
            data = _context2.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function getAllWishlist(_x4, _x5, _x6) {
